...
<head>
    <title>About Us - Sathi Shoes</title>
    <meta charset="utf-8" />
...
<body>
    ...
    <!-- about social links -->
    <section class="ab_social_links">
        <div class="ab_social_inner">

            <div class="social_main">
                <div id="social_main" class="social_main_inner d-flex gap-3 align-item-center">
                    <img

                        src="{{asset('images/shopping-cart.png')}}"
                        alt="" id="social_img">

                    <div class="social_desc d-flex flex-column align-item-center ">
                        <span class="social_title" id="social_title">Fast & Free Shipping</span>
                        <span class="social_sub_desc" id="social_sub_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, neque?</span>
                    </div>
                </div>
            </div>
            ...
            <div class="social_main">
                <div id="social_main" class="social_main_inner d-flex gap-3 align-item-center">
                    <img
                        src="{{asset('images/delivery-bold.png')}}"
                        alt="" id="social_img">

                    <div class="social_desc d-flex flex-column align-item-center ">
                        <span class="social_title" id="social_title">Delivery On Time</span>
                        <span class="social_sub_desc" id="social_sub_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, neque?</span>
                    </div>
                </div>
            </div>
            ...
            <div class="social_main">
                <div id="social_main" class="social_main_inner d-flex gap-3 align-item-center">
                    ...
                    <div class="social_desc d-flex flex-column align-item-center ">
                        <span class="social_title" id="social_title">Quality Guarantee</span>
                        <span class="social_sub_desc" id="social_sub_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, neque?</span>
                    </div>
                </div>
            </div>
            ...
            <div class="social_main">
                <div id="social_main" class="social_main_inner d-flex gap-3 align-item-center">
                    <img
                        src="{{asset('images/instagram-regular.png')}}"
                        alt="" id="social_img">

                    <div class="social_desc d-flex flex-column align-item-center ">
                        <span class="social_title" id="social_title">Follow Us</span>
                        <span class="social_sub_desc" id="social_sub_desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro, neque?</span>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-2 pb-3">
                    <div class="footer-menu">
                        ...
                        <div class="footer-contact-text">
                            <span>Sathi Shoes Store 711302, Howrah - India.
                            </span>
