...
<head>
    ...
    <title>Franchise Contact Details</title>
    <!-- plugins:css -->
                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="t_row_data">
                                                            ...
                                                            <td style="text-transform: capitalize;">9000000001</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Add Franchise Contact Details</h4>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="fr_con_icon">Icon</label>
                                <input type="text" class="form-control" id="fr_con_icon" name="fr_con_icon">
                                <small><a href="https://fontawesome.com/icons" target="_blank" style="text-decoration: underline;">Use icons from font awesome</a></small>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="fr_con_desc" class="form-control" id="fr_con_desc"></textarea>
                            </div>
        ...
        <div class="modal" id="myEditModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Franchise Contact Details</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
