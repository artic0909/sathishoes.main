...
<head>
    ...
    <title>Franchise Others Details</title>
    <!-- plugins:css -->
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Franchise Others Details</h3>
                                </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Add Franchise Others Details</h4>
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="fr_othr_title">Title</label>
                                <input type="text" class="form-control" id="fr_othr_title" name="fr_othr_title">
                            </div>


                            <div class="form-group">
                                <label for="sub_category">Description</label>
                                <textarea name="fr_othr_desc" class="form-control" id="fr_othr_desc"></textarea>
                            </div>
        ...
        <div class="modal" id="myEditModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Franchise Others Details</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>
