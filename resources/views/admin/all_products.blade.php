                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">All Product Details</h3>
                                </div>
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="version_category" id="version_category">
                                    <option style="text-transform: capitalize;" value="latest">Latest</option>
                                    <option style="text-transform: capitalize;" value="featured">Featured</option>
                                    <option style="text-transform: capitalize;" value="others">Others</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <small id="emailHelp" class="form-text text-muted">Use (,) between colors</small>
                            </div>


                            <div class="form-group">
                                <label for="product_sku">SKU Code</label>
