...
<head>
    <title>Saathi Shoes - Shoes Store</title>
    <meta charset="utf-8" />
                ...
                <div class="modal-body">
                    <div class="shopping-cart">
                        <div class="shopping-cart-content">
                                ...
                                <div class="mini-cart-item d-flex border-bottom pb-3">
                                    <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                        <a href="#" title="product-image">
                                            <img
                                                src="images/single-product-thumb1.jpg"
                                                class="img-fluid"
                            ...
                            <div class="mini-cart cart-list p-0 mt-3">
                                <div class="mini-cart-item d-flex border-bottom pb-3">
                                    <div class="col-lg-2 col-md-3 col-sm-2 me-4">
                                        <a href="#" title="product-image">
                                            <img
                                                src="images/single-product-thumb2.jpg"
                                                class="img-fluid"
                                                alt="single-product-item" />
                                        </a>
                                    </div>
                            ...
                            <!-- cart-list -->
                            <div
                                class="mini-cart-total d-flex justify-content-between py-4">
    ...
    <section id="featured-products" class="product-store">
        <div class="container-md">
            <div
                ...
                <div class="btn-right">
                    <a
                        href="featured-products.html"
                        class="d-inline-block text-uppercase text-hover fw-bold">View all</a>
                </div>
            </div>
