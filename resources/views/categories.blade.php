...
<head>
    <title>Categories - Sathi Shoes</title>
    <meta charset="utf-8" />
    ...
    <meta name="keywords" content="Sathi Shoes, best products, premium footwear, men's shoes, women's shoes, kids' shoes, shop online" />
...
<body>
    ...
    <!-- <div class="search-box bg-dark position-relative">
      <div class="search-wrap">
        ...
        <form
          id="search-form"
          class="text-lg-center text-md-left pt-3"
          action="index.html"
          method="get"
        >
        ...
        <nav id="header-nav" class="navbar navbar-expand-lg">
            <div class="container-lg">
                <a class="navbar-brand" href="/">
                    <img src="{{asset('images/logoS.png')}}" width="180" class="logo" alt="logo" />
                </a>
                <button
                    class="navbar-toggler d-flex d-lg-none order-3 border-0 p-1 ms-2"
                    type="button"
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar">
                    <div class="offcanvas-header px-4 pb-0">
                        ...
                        <button
                            type="button"
                            class="btn-close btn-close-black p-5"
                    ...
                    <div class="offcanvas-body">
                        <ul
                            ...
                            <li class="nav-item dropdown">
                                <a
                                    class="nav-link me-5 active dropdown-toggle border-0"
                                    href="#"
                                ...
                                <ul class="dropdown-menu fw-bold">
                                    ...
                                    <li>
                                        <a href="/featured-products" class="dropdown-item">Featured Products</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="nav-item">
                ...
                <div class="user-items ps-0 ps-md-5">
                    <ul
                        class="d-flex justify-content-end list-unstyled align-item-center m-0">
                        <li class="pe-3">
                        ...
                        <li>
                            <a href="#" class="search-item border-0">
                                <div>
                                    <i
          ...
          <div class="row justify-content-between align-items-center">
            ...
            <div class="col-lg-3 col-md-12">
              <div class="btn-wrap">
                <a
                  href="#"
                  class="btn btn-black btn-medium text-uppercase hvr-sweep-to-right"
                  >Email me</a
                >
              </div>
            </div>
    ...
    <section id="featured-products" class="product-store">
        <div class="container-md">
            <div
                ...
                <h2 class="section-title text-uppercase">Saathi Shoes Categories</h2>
            </div>
            ...
            <!-- men -->
            <section id="featured-products" class="product-store mt-5">
                <div class="container-md">
                    <div
                        class="display-header d-flex align-items-center justify-content-between">
                        <h2 class="section-title text-uppercase">Men</h2>

                        <!-- category names -->
                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Formal Shoes</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Casual Shoes</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Sports Shoes</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Boots</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Sneakers</a>
                        </div>
                    </div>

                    <!-- category with names & images -->
                                ...
                                <div class="product-card position-relative">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <button type="button" class="btn btn-light">
                                                    <a target="_blank" href="/sub-category"><i class="fa fa-search" aria-hidden="true"></i></a>
                                                </button>
                                            </div>
                                        </div>
                                        <!-- cart-concern -->
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Formmal shoes</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Casual Shoes</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Sports Shoes</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Boots</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Sneakers</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="featured-products" class="product-store mt-5">
                <div class="container-md">
                    <div
                        class="display-header d-flex align-items-center justify-content-between">
                        <h2 class="section-title text-uppercase">Women</h2>
                        ...
                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Hills</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Sandals</a>
                        </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Hills</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Sandals</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="featured-products" class="product-store mt-5">
                <div class="container-md">
                    <div
                        class="display-header d-flex align-items-center justify-content-between">
                        <h2 class="section-title text-uppercase">Kid</h2>
                        ...
                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Athletic Shoes</a>
                        </div>

                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">School Shoes</a>
                        </div>
                        ...
                        <div class="btn-right hideToShowBTNRight">
                            <a
                                href="/sub-category"
                                class="d-inline-block text-uppercase text-hover fw-bold">Slippers</a>
                        </div>
                    </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Athletic Shoes</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">School Shoes</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="product-card position-relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="card-title fs-6 fw-normal m-0">
                                            <a
                                                href="/sub-category"
                                                class="text-uppercase text-hover fw-bold">Slippers</a>
                                        </h3>
                                    </div>
                                </div>
                            </div>
    ...
    <footer id="footer" class="py-5 border-top">
        <div class="container-lg">
                ...
                <div class="col-lg-2 pb-3">
                    <div class="footer-menu">
                        ...
                        <div class="footer-contact-text">
                            <span>Sathi Shoes Store 711302, Howrah - India. </span>
            ...
            <div class="row">
                <div class="col-md-6">
                    <p>© Copyright Sathi Shoes 2024.</p>
                </div>
            </div>
        </div>
    </footer>
    ...
    <a href="" class="floating-btn-div">
        <button class="floating-btn1">
            <img src="{{asset('images/whatsapp.png')}}" width="50" alt="">
        </button>
    </a>
